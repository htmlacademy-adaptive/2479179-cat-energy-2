(function () {
  ...
  function styleInject(styles, ref) {
    if (ref === void 0) {
      ref = {};
    }
  ...
  class TwoUp extends HTMLElement {
    constructor() {
      ...
      this._handle.setAttribute('type', 'button');
